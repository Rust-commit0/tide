...
use super::{
    ConcurrentListener, FailoverListener, ParsedListener, TcpListener, ToListener,
};
...
mod parse_tests {
    ...
    mod not_unix {
        ...
        fn str_url_to_unix_listener() {
            ...
            assert_eq!(err.to_string(), "Unix sockets not supported on this platform");
        }
        #[test]
        fn colon_port_works() {
    ...
    fn invalid_str_input() {
        ...
        assert_eq!(err.to_string(), "unable to parse listener from `hello world`");
